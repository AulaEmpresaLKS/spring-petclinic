...
public class Owner extends Person {
    ...
    /**
     * Método dummy para forzar un posible bug: riesgo de NullPointerException.
     * Este método asume que el nombre de la mascota puede ser nulo.
     */
    ...
    /**
     * Método dummy para forzar un code smell relacionado con el manejo de excepciones.
     * Se utiliza un bloque catch vacío para capturar ArithmeticException.
     */
    ...
    /**
     * Método dummy adicional para forzar un bug y vulnerabilidad:
     * Construcción insegura de consulta SQL mediante concatenación de datos controlados por el usuario.
     *
     * @param userInput entrada controlada por el usuario
     * @return Consulta SQL construida de forma insegura
     */
